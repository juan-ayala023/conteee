...
const Footer = () => {
  return (
    <footer className="py-24 px-6 border-t border-white/5 flex flex-col items-center bg-obsidian">
      ...
      <nav className="flex gap-8 mb-10 text-white/30 text-xs font-bold uppercase tracking-widest">
